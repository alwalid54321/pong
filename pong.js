...
function onDeviceMove(event) {
    let acceleration = event.accelerationIncludingGravity.y;
  }
  // Map acceleration range to paddle direction
const ACCEL_RANGE = 20; 

if(acceleration > ACCEL_RANGE) {
  paddleDirection = 'down';
} else if(acceleration < -ACCEL_RANGE) {
  paddleDirection = 'up';
}
...
function drawEverything() {
  ...
  canvasContext.fillStyle = '#00a8ff';
  ...
  canvasContext.fillStyle = 'rgba(12, 206, 255, 0.849)';
  ...
  canvasContext.strokeStyle = 'rgba(241, 196, 15)';
  canvasContext.beginPath();
